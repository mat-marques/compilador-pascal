...
main: main.o HashTable.o List.o Item.o Lexicon.o
	g++ $(CFLAGS) -o main main.o HashTable.o List.o Item.o Lexicon.o
...
Lexicon.o: Lexicon.h Lexicon.cpp HashTable.h HashTable.cpp
